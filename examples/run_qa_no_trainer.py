...
def parse_args():
    ...
    parser.add_argument("--freeze_qa_outputs_layer", type=bool, default=False)
...
def main():
    ...
    if args.model_name_or_path:
        ...
        model = WARPPromptedRobertaForQuestionAnswering(
                                                         ...
                                                         freeze_qa_outputs_layer = args.freeze_qa_outputs_layer
                                                        )
    ...
    logger.info(f"  num of trainable parameters: {n_trainable_parameters}")
    logger.info(f"  freeze: {args.freeze_qa_outputs_layer}")
    ...
    for epoch in range(args.num_train_epochs):
        ...
        #         repo.push_to_hub(commit_message=f"Training in progress epoch {epoch}", blocking=False)
            ...
            # Evaluation
            if step % 500 == 0 or (epoch == args.num_train_epochs-1 and step == len(train_dataloader)):
                logger.info(f"***** Running Evaluation @step:{step}*****")
